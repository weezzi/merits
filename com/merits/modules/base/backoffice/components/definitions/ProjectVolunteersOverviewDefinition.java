package com.merits.modules.base.backoffice.components.definitions;
...
import com.merits.modules.base.backoffice.components.shared.ProjectVolunteersOverviewData;
 ...
 * @version 1.0
 */
public abstract class ProjectVolunteersOverviewDefinition extends WeezziBackOfficeComponent {
	...
	private enum Properties implements DynamicComponentProperties {
        ...
        Id(ComponentPropertyType.String),
		;
	 ...
	 * Default Constructor
	 */
	public ProjectVolunteersOverviewDefinition() {
		// Initializes component
		setComponentName("ProjectVolunteersOverview");
		// Set Component Type
    ...
    public void setComponentData(WeezziComponentData data) throws InvalidComponentDataException {
        try {
			...
			setStringPropertyValue("Id", componentData.getString("Id"));
