...
public abstract class GoodTypesTableDefinition extends WeezziTable {

	
	// CONSTRUCTORS -----------------------------------------------------------

	
	public GoodTypesTableDefinition() {
		// Initialization
		super();
		this.setName("GoodTypes");
	}
     ...
     */
    protected void addNonClickableRow(Long id, String name, String translations, EditInfo edit) {
     ...
     * @param edit Edit edit info parameter
     */
    protected void addRow(Long id, String name, String translations, EditInfo edit) {
        // Sets row as clickable
     ...
     * @param edit Edit edit info parameter
     */
    protected void addRow(Long id, Long clickId, String name, String translations, EditInfo edit) {
        // Sets row as clickable
        setClickableRow(true);
        // Sets the row id
        setRowId(encryptData(id));
