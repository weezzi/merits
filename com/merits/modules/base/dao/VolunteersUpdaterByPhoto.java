...
public class VolunteersUpdaterByPhoto implements UpdaterDAO {
	 ...
	 * Empty Constructor
	 **/
	public VolunteersUpdaterByPhoto(long id, Image photo, UpdateInfo updateInfo) {
        this.id = id;
        this.photo = photo;
	...
	public String getQuerySQL() {
		return "UPDATE VOLUNTEERS " +
               " SET PHOTO = ? , EDIT_INFO_UPDATE_DATE  = ? , EDIT_INFO_UPDATE_USER  = ?  " +
               " WHERE  ID = ?";
	}
	...
	public void updateFields(CallableStatement statement) throws Exception {
        ...
        if (photo == null) {
            ...
            statement.setString(1, photo.serialize());
        }
