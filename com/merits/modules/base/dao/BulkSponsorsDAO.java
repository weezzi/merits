...
/**
 * <b>Title: </b>Sponsor Bulk Data Transfer Object<br/>
 * <b>Description: </b>Sponsor Bulk DTO Class<br/>
 *
 * @author AUTO-GENERATED By Weezzi Builder
 * @version 1.0
 */
@SuppressWarnings("unused")
public class BulkSponsorsDAO extends BulkDAO {


	// CONSTANTS ---------------------------------------------------------------

	
	public static final String CACHE_PREFIX = "B15#";
    ...
    // Sponsor Bulk DTO Data Vector
    public Vector<SponsorsDAO> data;
    ...
    /**
     * Adds a Sponsor DAO to the data
     * @param sponsors SponsorsDAO Sponsor DAO
     */
    public void add(SponsorsDAO sponsors) {
        // Adds Sponsor
        data.add(sponsors);
    }
    ...
    /**
     * Adds a Sponsor from a recordset
     * @param rs ResultSet
     * @throws Exception
     */
    ...
    /**
     * Adds a collection of Sponsor DTO to the list
     * @param Collection Sponsor DTO Collection
     */
    ...
    /**
     * Gets a particular Sponsor DTO
     * @param index int Sponsor index
     * @return SponsorsDAO Sponsor data transfer data object
     */
    public SponsorsDAO get(int index) {
        // Gets one Sponsor from the bulk data
     ...
     * @return SponsorsDAO[] Sponsor DTO array
     */
    public SponsorsDAO[] getArray() {
        // Local variables
        SponsorsDAO[] array = new SponsorsDAO[data.size()];
        // Fill Array
