...
/**
 * <b>Title: </b>Shop Bulk Data Transfer Object<br/>
 * <b>Description: </b>Shop Bulk DTO Class<br/>
 *
 * @author AUTO-GENERATED By Weezzi Builder
 * @version 1.0
 */
@SuppressWarnings("unused")
public class BulkShopsDAO extends BulkDAO {


	// CONSTANTS ---------------------------------------------------------------

	
	public static final String CACHE_PREFIX = "B4#";
    ...
    // Shop Bulk DTO Data Vector
    public Vector<ShopsDAO> data;
    ...
    /**
     * Adds a Shop DAO to the data
     * @param shops ShopsDAO Shop DAO
     */
    public void add(ShopsDAO shops) {
        // Adds Shop
        data.add(shops);
    }
    ...
    /**
     * Adds a collection of Shop DTO to the list
     * @param Collection Shop DTO Collection
     */
    ...
    /**
     * Gets a particular Shop DTO
     * @param index int Shop index
     * @return ShopsDAO Shop data transfer data object
     */
    public ShopsDAO get(int index) {
        // Gets one Shop from the bulk data
     ...
     * @return ShopsDAO[] Shop DTO array
     */
    public ShopsDAO[] getArray() {
        // Local variables
        ShopsDAO[] array = new ShopsDAO[data.size()];
        // Fill Array
	...
	// GetAll Parameters Class -----------------------------------------------


	/**
	 * GetAll
	 */
	public class GetAllParameters extends DAOParameters {
		...
		public GetAllParameters(String search) {
            this.search = search;
		}
