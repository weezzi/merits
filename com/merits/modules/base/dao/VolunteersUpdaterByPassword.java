...
public class VolunteersUpdaterByPassword implements UpdaterDAO {
	 ...
	 * Empty Constructor
	 **/
	public VolunteersUpdaterByPassword(long id, String loginPassword, UpdateInfo updateInfo) {
        this.id = id;
	...
	public String getQuerySQL() {
		return "UPDATE VOLUNTEERS " +
               " SET LOGIN_PASSWORD = ? , EDIT_INFO_UPDATE_DATE  = ? , EDIT_INFO_UPDATE_USER  = ?  " +
               " WHERE  ID = ?";
	}
	...
	public void updateFields(CallableStatement statement) throws Exception {
        // Set Fields
        statement.setString(1, SecurityUtilities.encryptSalted(loginPassword, "VOLUNTEERS", "LOGIN_PASSWORD", id));
