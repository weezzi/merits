...
import com.merits.modules.base.site.components.definitions.ShopPaymentsDefinition;
...
/**
 * <b>Title: </b> ShopPayments<br/>
 * <b>Description: </b> <br/>
 *
 * @author Auto-generated by Weezzi Site Builder
 * @version 1.0
 */
public class ShopPayments extends ShopPaymentsDefinition {
	...
	private String renderPayments() {
		...
		map = expr.getAttributeMapper();
		try {
			records = BaseContainer.getShopTransactionsFindByShop(getSiteUserId());
		} catch (Exception e) {
			// Catch Exception
			Console.error("Error getting shop transactions for shop \"" + getSiteUserId() + "\"", e);;
			return "";
		}
		// Render records
