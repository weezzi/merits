...
import com.weezzi.core.sites.components.fields.ComponentFieldButtonGroup;
 ...
 * @version 1.0
 */
public abstract class BannerDefinition extends WeezziSiteComponent {
	...
	public ComponentPropertiesDefinition createDefaultPropertiesDefinition() {
		...
		definition.addProperty(new ComponentProperty("HasButtons", "Editor_HasButton", ComponentDefinitionPropertyType.OnOff));
		// Fields
		definition.addField(new ComponentFieldMedia(true, false, true, 1200, 600, "img", FieldContentType.Media, MediaType.Image).setHasLink(true));
		...
		definition.addField(new ComponentFieldText(new TextEditableOptions(false), false, "subtitle", ComponentTextType.Small, FieldContentType.ShortDescription));
		...
		definition.addField(new ComponentFieldButtonGroup("buttons"));
		return definition;
	}
	...
	public Vector<ComponentStyleDefinition> createDefaultStylesDefinition(ComponentPropertiesDefinition definition) {
		...
		// Default
		style = new ComponentStyleDefinition("Left", getComponentName(), ComponentType.ProjectSite, 0);
		style.setIsSystemKey(false);
		group = new StyleFieldsGroup("Default");
		group.addAllFields(definition);
		style.addGroup(group);
		styles.add(style);
		style = new ComponentStyleDefinition("Right", getComponentName(), ComponentType.ProjectSite, 1);
		style.setIsSystemKey(false);
		group = new StyleFieldsGroup("Default");
		group.addAllFields(definition);
		style.addGroup(group);
