 ...
 * @version 1.0
 */
public abstract class HomeBanner3VerticalDefinition extends WeezziSiteComponent {
	 ...
	 * Default Constructor
	 */
	public HomeBanner3VerticalDefinition() {
		// Initializes component
		setComponentName("HomeBanner3Vertical");
		// Set Component Type
	...
	public ComponentPropertiesDefinition createDefaultPropertiesDefinition() {
		...
		// Create definition
		definition.addField(new ComponentFieldMedia(true, false, true, 1200, 600, "img1", FieldContentType.Media, MediaType.Image));
		definition.addField(new ComponentFieldText(new TextEditableOptions(false), false, "title1", ComponentTextType.Small, FieldContentType.Title));
		definition.addField(new ComponentFieldText(new TextEditableOptions(false), false, "subtitle1", ComponentTextType.Small, FieldContentType.ShortDescription));
		definition.addField(new ComponentFieldText(new TextEditableOptions(false), false, "desc1", ComponentTextType.Medium, FieldContentType.ShortDescription));
		definition.addField(new ComponentFieldMedia(true, false, true, 1200, 600, "img2", FieldContentType.Media, MediaType.Image));
		definition.addField(new ComponentFieldText(new TextEditableOptions(false), false, "title2", ComponentTextType.Small, FieldContentType.Title));
		definition.addField(new ComponentFieldText(new TextEditableOptions(false), false, "subtitle2", ComponentTextType.Small, FieldContentType.ShortDescription));
		definition.addField(new ComponentFieldText(new TextEditableOptions(false), false, "desc2", ComponentTextType.Medium, FieldContentType.ShortDescription));
		definition.addField(new ComponentFieldMedia(true, false, true, 1200, 600, "img3", FieldContentType.Media, MediaType.Image));
		definition.addField(new ComponentFieldText(new TextEditableOptions(false), false, "title3", ComponentTextType.Small, FieldContentType.Title));
		definition.addField(new ComponentFieldText(new TextEditableOptions(false), false, "subtitle3", ComponentTextType.Small, FieldContentType.ShortDescription));
		definition.addField(new ComponentFieldText(new TextEditableOptions(false), false, "desc3", ComponentTextType.Medium, FieldContentType.ShortDescription));
		return definition;
	}
