...
import com.merits.modules.base.site.components.shared.ProjectsListData;
 ...
 * @version 1.0
 */
public abstract class ProjectsListDefinition extends WeezziSiteComponent {
	...
	private enum Properties implements DynamicComponentProperties {
        ...
        NumberOfProjects(ComponentPropertyType.Integer),
		;
    ...
    public void setComponentData(WeezziComponentData data) throws InvalidComponentDataException {
        try {
            ...
            this.NumberOfProjects = data.getInteger(ProjectsListData.NUMBEROFPROJECTS);
     ...
     */
    public void setProperties(Integer NumberOfProjects) {
