 ...
 * @version 1.0
 */
public abstract class HeaderDefinition extends WeezziSiteComponent {
	...
	public Vector<ComponentStyleDefinition> createDefaultStylesDefinition(ComponentPropertiesDefinition definition) {
		...
		// Default
		style = new ComponentStyleDefinition("Full", getComponentName(), ComponentType.ProjectSite, 0);
		style.setIsSystemKey(false);
		group = new StyleFieldsGroup("Default");
		group.addAllFields(definition);
		style.addGroup(group);
		styles.add(style);
		style = new ComponentStyleDefinition("Centered", getComponentName(), ComponentType.ProjectSite, 1);
		style.setIsSystemKey(false);
		group = new StyleFieldsGroup("Default");
		group.addAllFields(definition);
		style.addGroup(group);
