 ...
 * @version 1.0
 */
public abstract class TextDefinition extends WeezziSiteComponent {
	...
	public ComponentPropertiesDefinition createDefaultPropertiesDefinition() {
		...
		definition.addField(new ComponentFieldText(new TextEditableOptions(false), false, "text", ComponentTextType.Medium, FieldContentType.ShortDescription));
		return definition;
	}
	...
	public Vector<ComponentStyleDefinition> createDefaultStylesDefinition(ComponentPropertiesDefinition definition) {
		...
		// Default
		style = new ComponentStyleDefinition("Center", getComponentName(), ComponentType.ProjectSite, 0);
		style.setIsSystemKey(false);
		group = new StyleFieldsGroup("Default");
		group.addAllFields(definition);
		style.addGroup(group);
		styles.add(style);
		style = new ComponentStyleDefinition("Left", getComponentName(), ComponentType.ProjectSite, 1);
		style.setIsSystemKey(false);
		group = new StyleFieldsGroup("Default");
		group.addAllFields(definition);
		style.addGroup(group);
