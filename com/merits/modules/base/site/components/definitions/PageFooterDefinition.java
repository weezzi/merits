 ...
 * @version 1.0
 */
public abstract class PageFooterDefinition extends WeezziSiteComponent {
	 ...
	 * Default Constructor
	 */
	public PageFooterDefinition() {
		// Initializes component
		setComponentName("PageFooter");
		// Set Component Type
		setComponentType(SiteComponentType.Footer);		
		// Set Properties
