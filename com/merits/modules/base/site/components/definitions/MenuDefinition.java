 ...
 * @version 1.0
 */
public abstract class MenuDefinition extends WeezziSiteComponent {
	...
	public MenuDefinition() {
		...
		// Set Component Type
		setComponentType(SiteComponentType.Menu);
		// Set Properties
	...
	public ComponentPropertiesDefinition createDefaultPropertiesDefinition() {
		...
		definition.addProperty(new ComponentProperty("White", "Editor_WhiteLabel", ComponentDefinitionPropertyType.OnOff));
		definition.addProperty(new ComponentProperty("SelectedIndex", "Editor_SelectedMenu", ComponentDefinitionPropertyType.Slider));
