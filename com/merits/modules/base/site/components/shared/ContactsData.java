...
/**
 * <b>Title: </b> Contacts Data<br/>
 * <b>Description: </b> <br/>
 *
 * @author Auto-generated by Weezzi Site Builder
 * @version 1.0
 */
public class ContactsData implements WeezziComponentData {
	...
	public Boolean getBoolean(String propertyName) throws PropertyNotFoundException {
		...
		throw new PropertyNotFoundException("Property \"" + propertyName + "\" does not exist in ContactsData component");
	}
	...
	public Integer getInteger(String propertyName) throws PropertyNotFoundException {
		...
		throw new PropertyNotFoundException("Integer Property \"" + propertyName + "\" does not exist in ContactsData component");
	}
	...
	public Long getLong(String propertyName) throws PropertyNotFoundException {
		...
		throw new PropertyNotFoundException("Long Property \"" + propertyName + "\" does not exist in ContactsData component");
	}
	...
	public String getString(String propertyName) throws PropertyNotFoundException {
		...
		throw new PropertyNotFoundException("String Property \"" + propertyName + "\" does not exist in ContactsData component");
	}
	...
	public Object getObject(String propertyName) throws PropertyNotFoundException {
		...
		throw new PropertyNotFoundException("Object Property \"" + propertyName + "\" does not exist in ContactsData component");
	}
	...
	public List getList(String propertyName) throws PropertyNotFoundException {
		...
		throw new PropertyNotFoundException("List Property \"" + propertyName + "\" does not exist in ContactsData component");
	}
	...
	public Tree getTree(String propertyName) throws PropertyNotFoundException {
		...
		throw new PropertyNotFoundException("Tree Property \"" + propertyName + "\" does not exist in ContactsData component");
	}
